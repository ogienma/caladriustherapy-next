...
export default function BlogDetails() {
	...
	return (
		<>
			...
			<Layout mainContentCls="main-content" breadcrumbAlt breadcrumbTitle="Mindfulness For Better Mental Health...">
				{/* .section-blog-post */}
									...
									<div className="heading-blog">
										...
										<ul className="meta">
											<li className="meta-item">
												...
												<p className="text-1">October 16, 2024</p>
											</li>
											<li className="meta-item">
												<i className="icon-User" />
												<p className="text-1"> by <Link href="/#"> Dr. Emily Stevens</Link></p>
											</li>
										</ul>
									</div>
									<div className="main-image">
										<img className="lazyload" data-src="/images/blog/blog-details-1.jpg" src="/images/blog/blog-details-1.jpg" alt="healingy" />
									</div>
										...
										<li>
											<div className="comment-blog">
												<div className="author">
													...
													<div className="content">
														<ul className="meta">
															<li className="name text-3 fw-6"><Link href="/#">John Smit</Link></li>
															<li className="rating">
																<i className="icon-favorite_major" />
																<i className="icon-favorite_major" />
																<i className="icon-favorite_major" />
									...
									<form className="form-add-review">
										...
										<div className="cols">
											...
											<fieldset className="email">
												<input type="email" className="tf-input style-2" placeholder="Your Email*" tabIndex={2} aria-required="true" required />
											</fieldset>
										</div>
									...
									<div className="article-blog-item  hover-img ">
										...
										<div className="content">
											...
											<h5 className="title"><Link href="/blog-details">How Therapy Helps with
												Trauma:
												Pathways to Long-Term Healing</Link>
											</h5>
										</div>
									</div>
									<div className="list-post">
										<div className="box-listings hover-img">
											<div className="image-wrap">
												<Link href="/blog-details">
											...
											<div className="content">
												...
												<div className="title text-1 fw-5"> <Link href="/#">How Cognitive Behavioral Therapy
													Can Transform</Link>
												</div>
											</div>
										</div>
										<div className="box-listings hover-img">
											...
											<div className="content">
												...
												<div className="title text-1 fw-5">
													<Link href="/#"> Effective Strategies for Managing Anxiety</Link>
												</div>
											</div>
										</div>
										<div className="box-listings hover-img">
											...
											<div className="content">
												...
												<div className="title text-1 fw-5">
													<Link href="/#">How Therapy Can Help <br /> You Heal</Link>
												</div>
											</div>
										</div>
										<div className="box-listings hover-img">
											...
											<div className="content">
												...
												<div className="title text-1 fw-5">
													<Link href="/#">Techniques for Everyday Stress Relief</Link>
												</div>
											</div>
										</div>
									</div>
				...
				{/* .section-blog-news */}
				<section className="section-blog-news style-pagination">
					<div className="tf-container">
						<div className="row">
