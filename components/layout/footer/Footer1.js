						...
						<div className="col-12">
							<div className="footer-top">
								...
								<div className="wrap-social">
									<div className="text-3 fw-6 text-white">Follow Us On:</div>
							...
							<div className="footer-main">
								<div className="footer-menu-list footer-col-block">
									<h6 className="title title-desktop">Our Company</h6>
									<h6 className="title title-mobile">Our Company</h6>
									<ul className="tf-collapse-content">
										<li><Link href="/contact-us">Contact Us</Link></li>
										<li><Link href="/about">About Us</Link></li>
										<li><Link href="/book-appointment">Appointment</Link></li>
										<li><Link href="/blog-grid">Late News</Link></li>
										<li><Link href="/our-product">Our Shop</Link></li>
									</ul>
								</div>
								<div className="footer-menu-list footer-col-block">
									...
									<ul className="tf-collapse-content">
										...
										<li><Link href="/service-details">Child &amp; Adolescent Therapy</Link></li>
										<li><Link href="/service-details">Trauma Counseling</Link></li>
									</ul>
								</div>
								<div className="footer-menu-list footer-col-block">
									...
									<ul className="tf-collapse-content">
										...
										<li><Link href="/therapists-details">Kathryn Murphy</Link></li>
										<li><Link href="/therapists-details">Cameron Williamson</Link></li>
									</ul>
								</div>
								<div className="wrap-form footer-col-block">
									...
									<div className="tf-collapse-content">
										...
										<p>Please sign up to follow the latest news and events from us, we promise
											not to
											spam your inbox.</p>
									</div>
								</div>
